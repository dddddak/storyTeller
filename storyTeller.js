...
var drawScene2 = function(){
    currentScene = 2;
    background(176, 150, 150);
    image(seedling, 50, 200);
    text("Leafers grew up", 200, 50);
};

var drawScene3 = function(){
    currentScene = 3;
    background(148, 120, 120);
    image(sapling, 50, 200);
    text("Leafers grew up as a sapling", 200, 50);
};

var drawScene4 = function() {
    currentScene = 4;
    background(199, 175, 175);
    image(tree, 50, 200);
    text("Leafers became tree", 200, 50);
};
